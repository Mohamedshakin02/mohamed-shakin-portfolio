...
import WorkshopCertificates from './WorkshopCertificates';
...
function CertificateSection() {
    ...
    return (
        <section className="grid grid-cols-1 sm:grid-cols-8 sm:min-h-[700px] mt-10 sm:mt-0 custom-1580-grid">
            <div className="col-span-1 sm:col-span-3 lg:col-span-2 custom-1580-colsspan-2 bg-none text-black sm:text-white sm:bg-black flex flex-col sm:min-h-[700px] order-2">
